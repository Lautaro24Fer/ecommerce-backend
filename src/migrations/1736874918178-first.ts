...
export class First1736874918178 implements MigrationInterface {
    name = 'First1736874918178'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_product" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "isActive" boolean NOT NULL DEFAULT (1), "price" decimal(10,2) NOT NULL, "cost" decimal(10,2) NOT NULL, "name" varchar NOT NULL, "stock" integer NOT NULL DEFAULT (0), "description" text NOT NULL, "image" text NOT NULL, "typeId" integer, "brandId" integer, CONSTRAINT "FK_53bafe3ecc25867776c07c9e666" FOREIGN KEY ("typeId") REFERENCES "product_type" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_bb7d3d9dc1fae40293795ae39d6" FOREIGN KEY ("brandId") REFERENCES "brand" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_product"("id", "isActive", "price", "cost", "name", "stock", "description", "image", "typeId", "brandId") SELECT "id", "isActive", "price", "cost", "name", "stock", "description", "image", "typeId", "brandId" FROM "product"`);
        ...
        await queryRunner.query(`insert into product (name, price, cost, stock, description, image, typeId , brandId) values
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "isActive" boolean NOT NULL DEFAULT (1), "price" decimal(10,2) NOT NULL, "cost" decimal(10,2) NOT NULL, "name" varchar NOT NULL, "stock" integer NOT NULL DEFAULT (0), "description" text NOT NULL, "image" text NOT NULL, "typeId" integer, "brandId" integer)`);
        await queryRunner.query(`INSERT INTO "product"("id", "isActive", "price", "cost", "name", "stock", "description", "image", "typeId", "brandId") SELECT "id", "isActive", "price", "cost", "name", "stock", "description", "image", "typeId", "brandId" FROM "temporary_product"`);
