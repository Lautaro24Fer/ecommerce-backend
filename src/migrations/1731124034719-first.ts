...
export class First1731124034719 implements MigrationInterface {
    name = 'First1731124034719'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`price\` int NOT NULL, \`shippingCost\` float NOT NULL, \`quantity\` int NOT NULL DEFAULT '0', \`description\` text NOT NULL, \`image\` text NOT NULL, \`typeId\` int NULL, \`brandId\` int NULL, \`supplierId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`insert into product (name, price, shippingCost, quantity, description, image, typeId , brandId, supplierId) values
