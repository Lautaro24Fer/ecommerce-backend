...
export class First1733289363139 implements MigrationInterface {
    name = 'First1733289363139'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`paymentId\` varchar(255) NOT NULL, \`dateCreated\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`paymentMethod\` varchar(255) NOT NULL DEFAULT 'MP_TRANSFER', \`netPrice\` decimal(10,2) NOT NULL, \`IVA\` decimal(10,2) NOT NULL DEFAULT '21.00', \`total\` decimal(10,2) NOT NULL, \`profit\` decimal(10,2) NOT NULL, \`addressId\` int NULL, \`userId\` int NULL, UNIQUE INDEX \`IDX_9ad13532f48db4ac5a3b3dd70e\` (\`paymentId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
