...
export class First1731448074752 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`paymentId\` varchar(255) NOT NULL, \`dateCreated\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`devDateEstimated\` datetime NULL, \`devDate\` datetime NULL, \`paymentMethod\` varchar(255) NOT NULL DEFAULT 'mercadopago', \`isPayed\` tinyint NOT NULL DEFAULT 0, \`datePayed\` timestamp NULL, \`installments\` int NULL, \`addressId\` int NULL, \`userId\` int NULL, UNIQUE INDEX \`IDX_9ad13532f48db4ac5a3b3dd70e\` (\`paymentId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`order_product_order_product\` (\`orderId\` int NOT NULL, \`productId\` int NOT NULL, INDEX \`IDX_5497920a11e3e210b397937352\` (\`orderId\`), INDEX \`IDX_abdd4cff087f33261dcfe9ebc4\` (\`productId\`), PRIMARY KEY (\`orderId\`, \`productId\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`order_product_order_product\` DROP FOREIGN KEY \`FK_abdd4cff087f33261dcfe9ebc4b\``);
        await queryRunner.query(`ALTER TABLE \`order_product_order_product\` DROP FOREIGN KEY \`FK_5497920a11e3e210b397937352d\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_abdd4cff087f33261dcfe9ebc4\` ON \`order_product_order_product\``);
        await queryRunner.query(`DROP INDEX \`IDX_5497920a11e3e210b397937352\` ON \`order_product_order_product\``);
        await queryRunner.query(`DROP TABLE \`order_product_order_product\``);
